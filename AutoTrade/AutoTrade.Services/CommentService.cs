...
namespace AutoTrade.Services
{
    public class CommentService : BaseCRUDService<Model.Comment, BaseSerachObject, Comment, CommentInsertRequst, CommentUpdateRequest>, ICommentService
    {
        ...
        public override IQueryable<Comment> AddInclude(IQueryable<Comment> query, BaseSerachObject? search = null, bool includeDetails = false, bool includeDoneAds = false)
        {
