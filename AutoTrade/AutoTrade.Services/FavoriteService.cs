...
namespace AutoTrade.Services
{
    public class FavoriteService : BaseCRUDService<Model.Favorite, BaseSerachObject, Favorite, FavoriteUpsertRequst, FavoriteUpsertRequst>, IFavoriteService
    {
        ...
        public override IQueryable<Favorite> AddInclude(IQueryable<Favorite> query, BaseSerachObject? search = null, bool includeDetails = false, bool includeDoneAds = false)
        {
